...
PINNEN = {
    ...
    'muntje':       {'module': 'mcp2',  'pin': 1,   'pin_name': 'GPA1',     'direction': 'output',   'state': 'low'},	    # gaat hoog als er een muntje gewenst is
    'Kleur1':       {'module': 'mcp2',  'pin': 2,   'pin_name': 'GPA2',     'direction': 'output',   'state': 'low'},	    # bit 1 van de 2 bits kleur selector
    'Kleur2':       {'module': 'mcp2',  'pin': 3,   'pin_name': 'GPA3',     'direction': 'output',   'state': 'low'},	    # bit 2 van de 2 bits kleur selector
    'check':        {'module': 'mcp2',  'pin': 4,   'pin_name': 'GPA4',     'direction': 'output',   'state': 'low'},	    # gaat hoog als de data klaar staat
    'noodstop_out': {'module': 'mcp2',  'pin': 5,   'pin_name': 'GPA5',     'direction': 'output',   'state': 'low'},	    # gaat hoog als de noodstop procodure actief is (optie)
    'MCP2':         {'module': 'mcp2',  'pin': 7,   'pin_name': 'GPA7',     'direction': 'output',   'state': 'low'},	    # gaat aan waneer het script is gestart
    'mcp2Noodstop': {'module': 'mcp2',  'pin': 8,   'pin_name': 'GPB0',     'direction': 'input',    'pull': 'down'},	    # noodstop (deurtje) schakakelaar HIGH
    'PLCactief':    {'module': 'mcp2',  'pin': 9,   'pin_name': 'GPB1',     'direction': 'input',    'pull': 'down'},	    # gaat hoog als de PLC wacht
    'PLCbusy':      {'module': 'mcp2',  'pin': 10,  'pin_name': 'GPB2',     'direction': 'input',    'pull': 'down'},	    # gaat hoog als de PLC bezig is
